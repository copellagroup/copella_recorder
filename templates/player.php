...
<div class="app-container flex flex-col h-full max-w-4xl mx-auto w-full p-4 sm:p-6 pb-[calc(1rem+env(safe-area-inset-bottom))] bg-bg-color text-text-primary font-manrope min-h-screen antialiased">
    ...
    <header class="app-header fixed top-0 left-0 right-0 z-50 flex justify-between items-center py-4 px-4 bg-[#1a1a1a] border-b border-white/10">
        <!-- Кнопка "Назад" -->
        ...
        <div class="header-center flex-1 text-center">
            <img src="https://copella.live/wp-content/uploads/2025/09/Новый-проект-504-FCF08D2.png" alt="Copella Logo" class="header-logo h-20 sm:h-24 inline-block transition-all duration-300">
        </div>
    ...
    <main class="flex flex-col flex-grow overflow-hidden pt-24">
